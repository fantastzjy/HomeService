...
public class ShiroSpringConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/front/leaveWord.do", "anon");
        filterChainDefinitionMap.put("/front/postInfoList.do", "anon");
        filterChainDefinitionMap.put("/front/postInfoDetail.do", "anon");
